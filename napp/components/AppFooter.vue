          ...
          <div class="flex items-center justify-center">
            <div class="grid grid-cols-1 gap-2">
              ...
              <div id="subscriebe" class="flex items-center gap-0.5 py-2">
                ...
                <button class="h-8 px-8 text-base uppercase bg-white text-sky-900 shadow-xl shadow-gray-900/10">Подписаться</button>
              </div>
              ...
              <div class="flex items-start gap-2">
                ...
                <label for="privacy" class="text-xs text-white max-w-[30vw]">
