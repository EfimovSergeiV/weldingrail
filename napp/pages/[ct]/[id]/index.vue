...
<template>
  <div class="">
      ...
      <div class="flex items-center gap-8 bg-white pt-8">
        ...
        <div class="grid grid-cols-1 gap-6 w-full">
          ...
          <div class="bg-white py-2">
            ...
            <div class="flex items-center justify-end border-b border-sky-800">
              <div class="bg-slice-left bg-sky-800 py-2 px-32">
            ...
            <div class="px-8 ">
              ...
              <div class="flex gap-4 items-center justify-end py-4">
                ...
                <div class="flex items-center gap-4 ">
                  <label for="privacy" class="text-xs text-sky-800 text-right">
                    {{ $t('privacy') }}
                  </label>              
                  <input 
                    id="privacy"
    ...
    <div class="container mx-auto lg:max-w-7xl lg:px-8">
      <div class="bg-white py-8">
        <div class="flex  border-b border-sky-800">
          <div class="bg-sky-800 px-32 py-2 bg-slice-right">
    ...
    <div v-if="true" class="">
        ...
        <div id="product-property" class="container mx-auto lg:max-w-7xl lg:px-8">
          <div class=" bg-white flex gap-8 py-8 ">
            ...
            <div class="w-full text-sm">
              <div class="flex border-b border-sky-800">
                <div class=" bg-sky-800 px-20 py-2 bg-slice-right flex">
              ...
              <div class="px-8 grid grid-cols-1 gap-2 py-4">
                <div v-for="propdata in product.product_properties" :key="propdata.id" class="">
                  <div v-if="propdata.value" class="">
                    <div class="flex items-center justify-between text-base border-b border-sky-800/30 hover:border-sky-800/50 transition-all duration-300">
                      <p class="text-sky-800 se lect-none font-sans">{{ propdata.name }}</p>
                      <p class="text-sky-800 se lect-none font-sans font-semibold">{{ propdata.value }}</p>
                    </div>                
                  </div>
                  <div v-else class="">
                    <div class="flex items-center justify-start text-base mt-6">
                      <p class="text-sky-800 se lect-none font-sans font-semibold">{{ propdata.name }}</p>
                    </div>
                  </div>
            ...
            <div class=" w-1/3 hidden">
              <div class="my-2">
                <p class="text-xl text-sky-800 se lect-none font-sans font-semibold uppercase">Материалы:</p>
              </div>
              
              <div class="py-2 ">
                <div class="grid grid-cols-1 gap-2 text-sky-800">
      ...
      <div v-if="product.product_advantages.length > 0" class=" bg-sky-800 grid grid-cols-1 content-center py-4 border-t border-black/10">
        <div id="product-property" class="container mx-auto lg:max-w-7xl lg:px-8">
